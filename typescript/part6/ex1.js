...
var Circle = /** @class */ (function (_super) {
    ...
    Circle.prototype.toString = function () {
        return "Cricle[" + _super.prototype.toString.call(this) + ",radius=" + this.radius + "]";
    };
    return Circle;
}(Shape));
...
var Square = /** @class */ (function (_super) {
    ...
    Square.prototype.setHeight = function (side) {
        _super.prototype.setWidth.call(this, side);
        _super.prototype.setLength.call(this, side);
    };
...
console.log(new Square(5, 'blue', true).toString());
